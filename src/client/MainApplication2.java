...
//	protected UserDecisionPanel udPane;
	...
	{	
		...
		stPane.add( new JLabel("Assigned Character: Col. Mustard"));
		...
		disprovePane.playerCards.add( Card.HALL );
		disprovePane.playerCards.add(Card.MISS_SCARLET);
		disprovePane.playerCards.add(Card.MRS_WHITE);
		disprovePane.playerCards.add(Card.ROPE);
		disprovePane.createComponents();
		disprovePane.disproveButton.setEnabled(true);
		disprovePane.disproveButton.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				stPane.add( new JLabel("Col.Mustard's Disprove: null"));
				stPane.add( new JLabel("Mrs. White will make a Disprove"));
			}
	...
	public static void main( String[] a )
	{
		SwingUtilities.invokeLater( new Runnable()
		{
			@Override
			public void run() {
				MainApplication2 app = new MainApplication2();
				app.openGameGUI();
